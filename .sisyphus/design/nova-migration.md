# Nova migration surface

This note freezes the bounded migration surface for a future compressor backend
swap from Nova to MicroNova. The touch-point count stays deliberately small.
...
- `crates/pvthfhe-compressor/src/nova/mod.rs` — contains the Nova-specific adapter layer that would be replaced by a MicroNova implementation.
