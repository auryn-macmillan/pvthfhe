...
| P3 (Compress) | Nova Nova | `nova-bn254-grumpkin` |
...
- `compressor_backend_id()` requires feature gate `#[cfg(all(feature = "with-fhe", feature = "nova-compressor"))]` to match the `run_demo` function's gate — otherwise it's undefined.
