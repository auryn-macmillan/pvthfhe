...
- **Symptom**: `just demo-e2e` fails at "step 7/10: compressor_verify (sonobe-nova-bn254-grumpkin)" with "sonobe compressed proof verification failed"
...
- **Note**: This is a Sonobe Nova compressor issue, unrelated to the AjtaiMatrix wiring.
