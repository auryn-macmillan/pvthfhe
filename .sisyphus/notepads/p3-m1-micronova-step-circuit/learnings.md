...
## NovaCompressor state_len constraint
- `NovaCompressor::prove()` and `prove_steps()` hard-code pushing 3 initial state elements from decoded triple, requiring `state_len >= 3`.
...
- This is a design limitation of the current NovaCompressor — noted for future refactoring.
