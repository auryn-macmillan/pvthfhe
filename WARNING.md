...
- Noir circuits: real aggregation and wrapping logic; C0 keygen NIZK uses real BFV sigma proofs; C7 decryption aggregation is implemented via Sonobe C7DecryptAggregationCircuit and Merkle-tree folding
