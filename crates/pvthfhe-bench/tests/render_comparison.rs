...
fn synthetic_comparison() -> ComparisonEnvelope {
    ComparisonEnvelope {
        circuit_timings: vec![
            ...
            row("ZkDecryptedSharesAggregation", None, "n/a", "2:2 split-merge", 0, "merged Cyclo+Nova aggregation", Some("not wired")),
            row("ZkDecryptionAggregation", None, "n/a", "2:2 split-merge", 0, "merged Cyclo+Nova aggregation", Some("not wired")),
        ...
        backend_ids: BackendIds {
            ...
            compressor: "nova-bn254-grumpkin".to_owned(),
