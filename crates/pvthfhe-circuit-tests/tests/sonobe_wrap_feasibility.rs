//! Feasibility-doc guard for the Sonobe wrap spike.
...
#[test]
fn sonobe_wrap_feasibility_doc_records_binary_verdict() -> Result<(), Box<dyn std::error::Error>> {
    let doc_path = repo_root().join(".sisyphus/research/sonobe-wrap-feasibility.md");
