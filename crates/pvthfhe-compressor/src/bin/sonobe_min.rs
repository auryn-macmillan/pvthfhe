...
//!
//! NOTE: This binary uses the SonobeScaffold (non-arecibo) backend and is
...
fn main() {
    ...
    {
        eprintln!("sonobe-min-compressor is not available with the nova-backend feature");
        std::process::exit(1);
    }
