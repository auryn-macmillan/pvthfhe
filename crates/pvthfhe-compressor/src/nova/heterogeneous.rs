//! Heterogeneous IVC (MicroNova) support for Nova Nova.
//!
...
//!
//! ```ignore
//! use pvthfhe_compressor::nova::heterogeneous::HeterogeneousStepCircuit;
//! use pvthfhe_compressor::nova::latticefold_circuit_family::LatticeFoldTreeCircuitFamily;
//!
...
//!
//! // Then use NovaCompressor<HeterogeneousStepCircuit<Fr>> as usual.
//! ```
...
//
// NovaCompressor requires `Params = ()`, so the family cannot be passed
...
/// [`NovaCompressor`] with this step circuit. If not set, a default
...
impl<F: PrimeField> HeterogeneousStepCircuit<F> {
    ...
    ///
    /// Must be called before [`NovaCompressor::new`] with this step circuit.
