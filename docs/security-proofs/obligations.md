...
| P1 | P1-T1 | Honest witnesses satisfying the bounded decrypt-share relation and inherited SHA-256 commitment always yield an accepting P1 proof. | skeleton | docs/security-proofs/p1/theorem-inventory.md | §P1-Completeness |
| P1 | P1-T2 | Any accepting P1 prover in the ROM admits a rewinding extractor recovering \((s_i,e_i)\) consistent with the public ciphertext, commitment, and parameter bounds. | skeleton | docs/security-proofs/p1/theorem-inventory.md | §P1-KnowledgeSoundness |
| P1 | P1-T3 | The interactive HVZK proof for the joint SHA-256/RLWE relation compiles via Fiat-Shamir into a ROM NIZK for the full public statement. | skeleton | docs/security-proofs/p1/theorem-inventory.md | §P1-ZK |
| P1 | P1-T4 | Simulation-extractability is not part of the frozen P1 baseline because P2 does not consume simulated accepting P1 transcripts; a stronger theorem is required only if that interface changes. | skeleton | docs/security-proofs/p1/theorem-inventory.md | §P1-SimExtractability |
| P1 | P1-T5 | If P1 amortizes proofs across multiple decrypt shares, batch acceptance still implies per-share witness validity up to the stated aggregation loss. | skeleton | docs/security-proofs/p1/theorem-inventory.md | §P1-BatchSoundness |
