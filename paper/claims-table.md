...
| P2 | P2-A-T2 | Sonobe Knowledge Soundness: Sonobe Nova IVC verifier accepts only folded CCS instances consistent with committed hash-chain history (standard Nova IVC soundness). | PROVED | CONTINGENT (Lemma 9) | §6.A — Track A | docs/security-proofs/p2/T2.md |
...
| P2 | P2-A-T5 | On-chain Compatibility: final accumulated proof targets Solidity/Yul verification with ≤32 B proof size; gas costs verified via P3 surrogate. | PROVED | ASPIRATIONAL | §6.A — Track A | docs/security-proofs/p2/T5.md |
