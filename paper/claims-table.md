...
| C7 | C7-T1 | C7 Sonobe Nova step circuit (N=8) + Noir aggregator_final circuit. Folds per-participant Lagrange recombination. Production N=8192 via Merkle-proof verification deferred. | IMPLEMENTED (N=8) | ASPIRATIONAL | §Interfold-C7 | docs/security-proofs/interfold-equivalent-pvss.md |
