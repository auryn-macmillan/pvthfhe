...
\item[Track A (Concrete, \S\ref{sec:p2-tracka}):]
  ...
  state over three $\mathbb{F}_r$ scalars.  This track is fully implemented and benchmarked; theorems P2-A-T1 and P2-A-T3 are
...
rushing adversaries. We defer RSS to future work; misbehavior detection via retry
with subset selection is sufficient for honest-majority protocols.
