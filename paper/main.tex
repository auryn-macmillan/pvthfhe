...
% G2 full in-circuit Poseidon commitment verification (639K constraints/step)
% Real UltraHonk Solidity verifier generated and compiling (N=65536, 28 G1 points)
...
single canonical DKG path (Track A deprecated) with \texttt{FoldTrackKind::Sk} and \texttt{FoldTrackKind::ESm} share tracks;
...
\item[Track A (Concrete, \S\ref{sec:p2-tracka}):]
  ...
  state over three $\mathbb{F}_r$ scalars.  This track is fully implemented and benchmarked (DEPRECATED --- Track~B is the sole production path); theorems P2-A-T1 and P2-A-T3 are
  PROVED, P2-A-T2 is PENDING-NOVA-PROOF, P2-A-T4 is CONDITIONAL, and
  P2-A-T5 is PARTIAL (2/6).
...
% ===================================================================
\subsection{Track A: Sonobe Nova IVC (Concrete) \textbf{[DEPRECATED]}}
\label{sec:p2-tracka}
